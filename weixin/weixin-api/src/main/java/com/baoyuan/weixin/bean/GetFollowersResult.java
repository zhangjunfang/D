 ...
 * 获取关注者列表结果
 */
public class GetFollowersResult extends AbstractParser {
  ...
  public static GetFollowersResult parse(JSONObject jsonObject) {
    ...
    obj.total = ResultParser.parseInteger(jsonObject.get("total"));
    obj.count = ResultParser.parseInteger(jsonObject.get("count"));
    obj.nextOpenid = ResultParser.toString(jsonObject.opt("next_openid"));
