		...
		$(function (){
            ...
            $("#dataGrid").ligerGrid({
                columns: [
		            ...
		            { display:'用户昵称',name:'nickname', minWidth: 60,width:150,align: 'center'},
		            { display:'性别',name:'gender', minWidth: 60,width:70, align: 'center' ,render:function(rowdata){
		            	var array=new Array();
		            	array[0]="未知";
						array[1]="男";
						array[2]="女";
		            	return array[rowdata.gender];
		            }},
		            { display:'省份',name:'province', minWidth: 60,width:120, align: 'center'},
		            { display:'城市',name:'city', minWidth: 60,width:120, align: 'center'},
		            { display:'所属分组',name:'groupId', minWidth: 60,width:120, align: 'center',render:function(rowdata){
		            	var group =${group};
		            	return group[rowdata.groupId];
		            }},
		            { display:'关注日期',name:'subscribeTime',type:'datetime', minWidth: 60,width:150,align: 'center' },
