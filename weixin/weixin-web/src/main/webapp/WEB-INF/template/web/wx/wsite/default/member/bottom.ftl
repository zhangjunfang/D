...
<!-- 网站Bottom -->
<div class="i_client">
	<div class="i_client_h">
	<ul>
		<li class="fl">电子会员卡</li>
		<li class="fl">卡片绑定</li>
		<li class="fl">查询积分</li>
	</ul>
  </div>
...
<script type="text/javascript">
	...
	if(index>0){
	  ...
	  <#list shopList as list>
	  	{text:'${list.name}',icon:'grid',href:'${base}/web/wx/casement/shop/${list.id}?redirectionUrl='+redirectionUrl}<#if list_has_next>,</#if>
	  </#list>
	  </#if>
    ];
	 var nav=[
