...
public class WxMenuController extends BaseAdminController {
	...
	public String list(Model model) {
		...
		List<WxConfig> configs = wxConfigService.getAll(
	...
	public String add(@PathVariable String tenantId, @PathVariable String wid,
		...
		List<WxMenu> parentMenus = wxMenuService.getList(
				WxGlobal.DATASOURCE_WEIXIN, getCurrentUser().getTenantId(),
				criteria);
	...
	public String edit(@PathVariable String id, Model model) {
		...
		WxMenu menu = wxMenuService.get(WxGlobal.DATASOURCE_WEIXIN,
	...
	Object save(WxMenu wxMenu) {
		try {
			...
			wxMenuService.save(WxGlobal.DATASOURCE_WEIXIN, getCurrentUser()
					.getTenantId(), wxMenu);
	...
	Object update(@PathVariable("id") String id, WxMenu wxMenu) {
		try {
			...
			wxMenuService.update(WxGlobal.DATASOURCE_WEIXIN, getCurrentUser()
					.getTenantId(), wxMenu);
